...
def get_package( name, directories, unique_file, repo_url, tar_url, tar_filename ):
    ...
    Looks for a directory from given list of directories. It checks for
    existence of unique_file in the directory, to ensure the directory
    actually contains the source.
    If found, returns that directory.
    If none found, tries to 'git clone repo_url' to the last directory.
