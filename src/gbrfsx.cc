...
#if LAPACK_VERSION_MAJOR >= 3 && LAPACK_VERSION_MINOR >= 2  // >= v3.2
...
///     - lapack::Op::ConjTrans: \f$ A^H X = B \f$ (Conjugate transpose = Transpose)
///
/// @param[in] equed
...
///     - lapack::Equed::Row:  Row equilibration, i.e.,
///          A has been premultiplied by diag(R).
///     - lapack::Equed::Col:  Column equilibration, i.e.,
///          A has been postmultiplied by diag(C).
///     - lapack::Equed::Both: Both row and column equilibration, i.e.,
...
///     guaranteed.
/// @retval > 0 and <= n: if value = i, U(i,i) is exactly zero. The factorization
///     has been completed, but the factor U is exactly singular, so
///     the solution and error bounds could not be computed. RCOND = 0
///     is returned.
/// @retval > n: if value = j-n, the solution corresponding to the j-th
///     right-hand side is
