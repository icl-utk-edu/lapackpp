    ...
    float* B, int64_t ldb )
{
    ...
    LAPACK_spbtrs( &uplo_, &n_, &kd_, &nrhs_, AB, &ldab_, B, &ldb_, &info_ );
    if (info_ < 0) {
        throw Error();
    }
    return info_;
    ...
    double* B, int64_t ldb )
{
    ...
    LAPACK_dpbtrs( &uplo_, &n_, &kd_, &nrhs_, AB, &ldab_, B, &ldb_, &info_ );
    if (info_ < 0) {
        throw Error();
    }
    return info_;
    ...
    std::complex<float>* B, int64_t ldb )
{
    ...
    LAPACK_cpbtrs( &uplo_, &n_, &kd_, &nrhs_, AB, &ldab_, B, &ldb_, &info_ );
    if (info_ < 0) {
        throw Error();
    }
    return info_;
    ...
    std::complex<double>* B, int64_t ldb )
{
    ...
    LAPACK_zpbtrs( &uplo_, &n_, &kd_, &nrhs_, AB, &ldab_, B, &ldb_, &info_ );
    if (info_ < 0) {
        throw Error();
    }
    return info_;
