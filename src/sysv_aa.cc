    ...
    float* B, int64_t ldb )
{
    ...
    float qry_work[1];
    blas_int ineg_one = -1;
    LAPACK_ssysv_aa( &uplo_, &n_, &nrhs_, A, &lda_, ipiv_ptr, B, &ldb_, qry_work, &ineg_one, &info_ );
    if (info_ < 0) {
        throw Error();
    }
    ...
    LAPACK_ssysv_aa( &uplo_, &n_, &nrhs_, A, &lda_, ipiv_ptr, B, &ldb_, &work[0], &lwork_, &info_ );
    if (info_ < 0) {
        throw Error();
    }
    #if 1
    ...
    double* B, int64_t ldb )
{
    ...
    double qry_work[1];
    blas_int ineg_one = -1;
    LAPACK_dsysv_aa( &uplo_, &n_, &nrhs_, A, &lda_, ipiv_ptr, B, &ldb_, qry_work, &ineg_one, &info_ );
    if (info_ < 0) {
        throw Error();
    }
    blas_int lwork_ = real(qry_work[0]);
    ...
    LAPACK_dsysv_aa( &uplo_, &n_, &nrhs_, A, &lda_, ipiv_ptr, B, &ldb_, &work[0], &lwork_, &info_ );
    if (info_ < 0) {
        throw Error();
    }
    #if 1
    ...
    std::complex<float>* B, int64_t ldb )
{
    ...
    blas_int ineg_one = -1;
    LAPACK_csysv_aa( &uplo_, &n_, &nrhs_, A, &lda_, ipiv_ptr, B, &ldb_, qry_work, &ineg_one, &info_ );
    if (info_ < 0) {
        throw Error();
    }
    blas_int lwork_ = real(qry_work[0]);
    ...
    LAPACK_csysv_aa( &uplo_, &n_, &nrhs_, A, &lda_, ipiv_ptr, B, &ldb_, &work[0], &lwork_, &info_ );
    if (info_ < 0) {
        throw Error();
    }
    #if 1
    ...
    std::complex<double>* B, int64_t ldb )
{
    ...
    blas_int ineg_one = -1;
    LAPACK_zsysv_aa( &uplo_, &n_, &nrhs_, A, &lda_, ipiv_ptr, B, &ldb_, qry_work, &ineg_one, &info_ );
    if (info_ < 0) {
        throw Error();
    }
    blas_int lwork_ = real(qry_work[0]);
    ...
    LAPACK_zsysv_aa( &uplo_, &n_, &nrhs_, A, &lda_, ipiv_ptr, B, &ldb_, &work[0], &lwork_, &info_ );
    if (info_ < 0) {
        throw Error();
    }
    #if 1
