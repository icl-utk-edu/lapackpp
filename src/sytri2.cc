    ...
    int64_t const* ipiv )
{
    ...
    float qry_work[1];
    blas_int ineg_one = -1;
    LAPACK_ssytri2( &uplo_, &n_, A, &lda_, ipiv_ptr, qry_work, &ineg_one, &info_ );
    if (info_ < 0) {
        throw Error();
    }
    ...
    LAPACK_ssytri2( &uplo_, &n_, A, &lda_, ipiv_ptr, &work[0], &lwork_, &info_ );
    if (info_ < 0) {
        throw Error();
    }
    return info_;
    ...
    int64_t const* ipiv )
{
    ...
    double qry_work[1];
    blas_int ineg_one = -1;
    LAPACK_dsytri2( &uplo_, &n_, A, &lda_, ipiv_ptr, qry_work, &ineg_one, &info_ );
    if (info_ < 0) {
        throw Error();
    }
    blas_int lwork_ = real(qry_work[0]);
    ...
    LAPACK_dsytri2( &uplo_, &n_, A, &lda_, ipiv_ptr, &work[0], &lwork_, &info_ );
    if (info_ < 0) {
        throw Error();
    }
    return info_;
    ...
    int64_t const* ipiv )
{
    ...
    blas_int ineg_one = -1;
    LAPACK_csytri2( &uplo_, &n_, A, &lda_, ipiv_ptr, qry_work, &ineg_one, &info_ );
    if (info_ < 0) {
        throw Error();
    }
    blas_int lwork_ = real(qry_work[0]);
    ...
    LAPACK_csytri2( &uplo_, &n_, A, &lda_, ipiv_ptr, &work[0], &lwork_, &info_ );
    if (info_ < 0) {
        throw Error();
    }
    return info_;
    ...
    int64_t const* ipiv )
{
    ...
    blas_int ineg_one = -1;
    LAPACK_zsytri2( &uplo_, &n_, A, &lda_, ipiv_ptr, qry_work, &ineg_one, &info_ );
    if (info_ < 0) {
        throw Error();
    }
    blas_int lwork_ = real(qry_work[0]);
    ...
    LAPACK_zsytri2( &uplo_, &n_, A, &lda_, ipiv_ptr, &work[0], &lwork_, &info_ );
    if (info_ < 0) {
        throw Error();
    }
    return info_;
