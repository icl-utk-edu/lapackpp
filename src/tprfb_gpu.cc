    ...
    lapack::Queue& queue )
{
    ...
    column = (storev == StoreV::Columnwise);
    row = ! column;
    ...
    if (column && forward && left) {
        ...
        blas::trmm( Layout::ColMajor, Side::Left, Uplo::Upper, op_trans,
                    Diag::NonUnit, l, n,
                    one, V_21, lddv, work_1, ldwork, queue );

        // work_1 = V_11^H B_1 + work_1
        blas::gemm( Layout::ColMajor, op_trans, Op::NoTrans, l, n, m - l,
                    one, V_11, lddv, B_1, lddb,
                    one, work_1, ldwork, queue );

        // work_2 = V_x2^H B + work_2
        blas::gemm( Layout::ColMajor, op_trans, Op::NoTrans, k - l, n, m,
                    one, V_x2, lddv, dB, lddb,
                    zero, work_2, ldwork, queue );

        //----------
        // work = A + V^H B
        // work += A
        blas::geadd( Layout::ColMajor, Op::NoTrans, k, n,
                     one, dA, ldda,
                     one, work, ldwork, queue );

        //----------
        // work = op(T) (A + V^H B)
        // work = op(T) work
        blas::trmm( Layout::ColMajor, Side::Left, Uplo::Upper, trans,
                    Diag::NonUnit, k, n,
                    one, dT, lddt, work, ldwork, queue );
        ...
        // B_1 = -V_1x work + B_1
        blas::gemm( Layout::ColMajor, Op::NoTrans, Op::NoTrans, m - l, n, k,
                    -one, V_1x, lddv, work, ldwork,
                    one, B_1, lddb, queue );

        // B_2 = -V_22 work_2 + B_2
        blas::gemm( Layout::ColMajor, Op::NoTrans, Op::NoTrans, l, n, k - l,
                    -one, V_22, lddv, work_2, ldwork,
                    one, B_2, lddb, queue );
        ...
        // B_2 = B_2 - work_1
        blas::geadd( Layout::ColMajor, Op::NoTrans, l, n,
                     one, work_1, ldwork,
                     one, B_2, lddb, queue );
    }
        ...
        blas::gemm( Layout::ColMajor, Op::NoTrans, Op::NoTrans, m, l, n - l,
                    one, B_1, lddb, V_11, lddv,
                    one, work_1, ldwork, queue );

        // work_2 = B V_x2 + work_2
        blas::gemm( Layout::ColMajor, Op::NoTrans, Op::NoTrans, m, k - l, n,
                    one, dB, lddb, V_x2, lddv,
                    zero, work_2, ldwork, queue );

        //----------
        // work = A + B V
        // work = work + A
        blas::geadd( Layout::ColMajor, Op::NoTrans, m, k,
                     one, dA, ldda,
                     one, work, ldwork, queue );
        ...
        // work = (A + B V) op(T)
        // work = work op(T)
        blas::trmm( Layout::ColMajor, Side::Right, Uplo::Upper, trans,
                    Diag::NonUnit, m, k,
                    one, dT, lddt, work, ldwork, queue );
        ...
        // B_1 = -work V_1x^H + B_1
        blas::gemm( Layout::ColMajor, Op::NoTrans, op_trans, m, n - l, k,
                    -one, work, ldwork, V_1x, lddv,
                    one, B_1, lddb, queue );

        // B_2 = -work_2 V_22^H + B_2
        blas::gemm( Layout::ColMajor, Op::NoTrans, op_trans, m, l, k - l,
                    -one, work_2, ldwork, V_22, lddv,
                    one, B_2, lddb, queue );

        // work_1 = work_1 V_21^H
        blas::trmm( Layout::ColMajor, Side::Right, Uplo::Upper, op_trans,
                    Diag::NonUnit, m, l,
                    one, V_21, lddv, work_1, ldwork, queue );

        // B_2 = B_2 - work_1
        blas::geadd( Layout::ColMajor, Op::NoTrans, m, l,
                     -one, work_1, ldwork,
                     one, B_2, lddb, queue );
    }
        ...
        blas::trmm( Layout::ColMajor, Side::Left, Uplo::Lower, op_trans,
                    Diag::NonUnit, l, n,
                    one, V_12, lddv, work_2, ldwork, queue );

        // work_2 = V_22^H B_2 + work_2
        blas::gemm( Layout::ColMajor, op_trans, Op::NoTrans, l, n, m - l,
                    one, V_22, lddv, B_2, lddb,
                    one, work_2, ldwork, queue );

        // work_1 = V_x1^H B + work_1
        blas::gemm( Layout::ColMajor, op_trans, Op::NoTrans, k - l, n, m,
                    one, V_x1, lddv, dB, lddb,
                    zero, work_1, ldwork, queue );
        ...
        // work = op(T) (A + V^H B)
        // work = op(T) work
        blas::trmm( Layout::ColMajor, Side::Left, Uplo::Lower, trans,
                    Diag::NonUnit, k, n,
                    one, dT, lddt, work, ldwork, queue );
        ...
        // B_2 = -V_2x work + B_2
        blas::gemm( Layout::ColMajor, Op::NoTrans, Op::NoTrans, m - l, n, k,
                    -one, V_2x, lddv, work, ldwork,
                    one, B_2, lddb, queue );

        // B_1 = -V_11 work_1 + B_1
        blas::gemm( Layout::ColMajor, Op::NoTrans, Op::NoTrans, l, n, k - l,
                    -one, V_11, lddv, work_1, ldwork,
                    one, B_1, lddb, queue );

        // work_2 = V_12 work_2
        blas::trmm( Layout::ColMajor, Side::Left, Uplo::Lower, Op::NoTrans,
                    Diag::NonUnit, l, n,
                    one, V_12, lddv, work_2, ldwork, queue );
        ...
        blas::trmm( Layout::ColMajor, Side::Right, Uplo::Lower, Op::NoTrans,
                    Diag::NonUnit, m, l,
                    one, V_12, lddv, work_2, ldwork, queue );

        // work_2 = B2 V_22 + work_2
        blas::gemm( Layout::ColMajor, Op::NoTrans, Op::NoTrans, m, l, n - l,
                    one, B_2, lddb, V_22, lddv,
                    one, work_2, ldwork, queue );

        // work_1 = B V_x1 + work_1
        blas::gemm( Layout::ColMajor, Op::NoTrans, Op::NoTrans, m, k - l, n,
                    one, dB, lddb, V_x1, lddv,
                    zero, work_1, ldwork, queue );
        ...
        // work = (A + B V) op(T)
        // work = work op(T)
        blas::trmm( Layout::ColMajor, Side::Right, Uplo::Lower, trans,
                    Diag::NonUnit, m, k,
                    one, dT, lddt, work, ldwork, queue );
        ...
        // B_2 = -work V_2x^H + B_2
        blas::gemm( Layout::ColMajor, Op::NoTrans, op_trans, m, n - l, k,
                    -one, work, ldwork, V_2x, lddv,
                    one, B_2, lddb, queue );

        // B_1 = -work_1 V_11^H + B_1
        blas::gemm( Layout::ColMajor, Op::NoTrans, op_trans, m, l, k - l,
                    -one, work_1, ldwork, V_11, lddv,
                    one, B_1, lddb, queue );

        // work_2 = work_2 V_12^H
        blas::trmm( Layout::ColMajor, Side::Right, Uplo::Lower, op_trans,
                    Diag::NonUnit, m, l,
                    one, V_12, lddv, work_2, ldwork, queue );
        ...
        blas::trmm( Layout::ColMajor, Side::Left, Uplo::Lower, Op::NoTrans,
                    Diag::NonUnit, l, n,
                    one, V_12, lddv, work_1, lddb, queue );

        // work_1 = V_11 B_1 + work_1
        blas::gemm( Layout::ColMajor, Op::NoTrans, Op::NoTrans, l, n, m - l,
                    one, V_11, lddv, B_1, lddb,
                    one, work_1, ldwork, queue );

        // work_2 = V_2x B + work_2
        blas::gemm( Layout::ColMajor, Op::NoTrans, Op::NoTrans, k - l, n, m,
                    one, V_2x, lddv, dB, lddb,
                    zero, work_2, ldwork, queue );
        ...
        // B_1 = -V_x1^H work + B_1
        blas::gemm( Layout::ColMajor, op_trans, Op::NoTrans, m - l, n, k,
                    -one, V_x1, lddv, work, ldwork,
                    one, B_1, lddb, queue );

        // B_2 = -V_22^H work_2 + B_2
        blas::gemm( Layout::ColMajor, op_trans, Op::NoTrans, l, n, k - l,
                    -one, V_22, lddv, work_2, ldwork,
                    one, B_2, lddb, queue );
        ...
        blas::trmm( Layout::ColMajor, Side::Left, Uplo::Lower, op_trans,
                    Diag::NonUnit, l, n,
                    one, V_12, lddv, work_1, ldwork, queue );
        ...
        blas::gemm( Layout::ColMajor, Op::NoTrans, op_trans, m, l, n - l,
                    one, B_1, lddb, V_11, lddv,
                    one, work_1, ldwork, queue );

        // work_2 = B V_2x^H + work_2
        blas::gemm( Layout::ColMajor, Op::NoTrans, op_trans, m, k - l, n,
                    one, dB, lddb, V_2x, lddv,
                    zero, work_2, ldwork, queue );
        ...
        // B_1 = -work V_x1 + B_1
        blas::gemm( Layout::ColMajor, Op::NoTrans, Op::NoTrans, m, n - l, k,
                    -one, work, ldwork, V_x1, lddv,
                    one, B_1, lddb, queue );

        // B_2 = -work_2 V_22 + B_2
        blas::gemm( Layout::ColMajor, Op::NoTrans, Op::NoTrans, m, l, k - l,
                    -one, work_2, ldwork, V_22, lddv,
                    one, B_2, lddb, queue );
        ...
        blas::trmm( Layout::ColMajor, Side::Left, Uplo::Upper, Op::NoTrans,
                    Diag::NonUnit, l, n,
                    one, V_21, lddv, work_2, ldwork, queue );
