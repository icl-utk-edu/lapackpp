    ...
    float* berr )
{
    ...
    LAPACK_stprfs( &uplo_, &trans_, &diag_, &n_, &nrhs_, AP, B, &ldb_, X, &ldx_, ferr, berr, &work[0], &iwork[0], &info_ );
    if (info_ < 0) {
        throw Error();
    }
    return info_;
    ...
    double* berr )
{
    ...
    LAPACK_dtprfs( &uplo_, &trans_, &diag_, &n_, &nrhs_, AP, B, &ldb_, X, &ldx_, ferr, berr, &work[0], &iwork[0], &info_ );
    if (info_ < 0) {
        throw Error();
    }
    return info_;
    ...
    float* berr )
{
    ...
    LAPACK_ctprfs( &uplo_, &trans_, &diag_, &n_, &nrhs_, AP, B, &ldb_, X, &ldx_, ferr, berr, &work[0], &rwork[0], &info_ );
    if (info_ < 0) {
        throw Error();
    }
    return info_;
    ...
    double* berr )
{
    ...
    LAPACK_ztprfs( &uplo_, &trans_, &diag_, &n_, &nrhs_, AP, B, &ldb_, X, &ldx_, ferr, berr, &work[0], &rwork[0], &info_ );
    if (info_ < 0) {
        throw Error();
    }
    return info_;
