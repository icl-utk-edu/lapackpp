...
# LAPACK only
group_opt.add_argument( '--direct', action='store', help='default=f,b',       default='f,b' )
group_opt.add_argument( '--storev', action='store', help='default=c,r',       default='c,r' )
group_opt.add_argument( '--norm',   action='store', help='default=max,1,inf,fro', default='max,1,inf,fro' )
group_opt.add_argument( '--matrixtype', action='store', help='default=g,l,u',   default='g,l,u' )
