...
Params::Params():
    ...
    test_matrix_cond ("Condition Number", 11, 4, ParamType::Value, 100, 1.0, 10000, "matrix condition number" ),
    test_matrix_condD ("Condition Number", 11, 4, ParamType::Value, 100, 1.0, 10000, "matrix condition number" )
{
