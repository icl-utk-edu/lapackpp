...
static lapack_int LAPACKE_hesv(
...
{
    return LAPACKE_chesv( LAPACK_COL_MAJOR, uplo, n, nrhs, A, lda, ipiv, B, ldb );
}
...
{
    return LAPACKE_zhesv( LAPACK_COL_MAJOR, uplo, n, nrhs, A, lda, ipiv, B, ldb );
}
