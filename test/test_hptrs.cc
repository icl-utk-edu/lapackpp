...
static lapack_int LAPACKE_hptrs(
...
{
    return LAPACKE_chptrs( LAPACK_COL_MAJOR, uplo, n, nrhs, AP, ipiv, B, ldb );
}

static lapack_int LAPACKE_hptrs(
    char uplo, lapack_int n, lapack_int nrhs, std::complex<double>* AP, lapack_int* ipiv, std::complex<double>* B, lapack_int ldb )
{
    return LAPACKE_zhptrs( LAPACK_COL_MAJOR, uplo, n, nrhs, AP, ipiv, B, ldb );
}
...
void test_hptrs_work( Params& params, bool run )
{
    ...
    // double gflop = lapack::Gflop< scalar_t >::hptrs( n, nrhs );
