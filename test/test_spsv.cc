...
static lapack_int LAPACKE_spsv(
...
{
    return LAPACKE_cspsv( LAPACK_COL_MAJOR, uplo, n, nrhs, AP, ipiv, B, ldb );
}

static lapack_int LAPACKE_spsv(
    char uplo, lapack_int n, lapack_int nrhs, std::complex<double>* AP, lapack_int* ipiv, std::complex<double>* B, lapack_int ldb )
{
    return LAPACKE_zspsv( LAPACK_COL_MAJOR, uplo, n, nrhs, AP, ipiv, B, ldb );
}
