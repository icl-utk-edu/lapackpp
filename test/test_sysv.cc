...
{
    return LAPACKE_csysv( LAPACK_COL_MAJOR, uplo, n, nrhs, A, lda, ipiv, B, ldb );
}
...
{
    return LAPACKE_zsysv( LAPACK_COL_MAJOR, uplo, n, nrhs, A, lda, ipiv, B, ldb );
}

// -----------------------------------------------------------------------------
template< typename scalar_t >
void test_sysv_work( Params& params, bool run )
{
    ...
    int64_t info_tst = lapack::sysv( uplo, n, nrhs, &A_tst[0], lda, &ipiv_tst[0], &B_tst[0], ldb );
    time = omp_get_wtime() - time;
    if (info_tst != 0) {
        fprintf( stderr, "lapack::sysv returned error %lld\n", (lld) info_tst );
    }

    // double gflop = lapack::Gflop< scalar_t >::sysv( n, nrhs );
...
void test_sysv( Params& params, bool run )
{
    switch (params.datatype.value()) {
        ...
        case libtest::DataType::Double:
            test_sysv_work< double >( params, run );
            break;

        case libtest::DataType::SingleComplex:
            test_sysv_work< std::complex<float> >( params, run );
            break;
